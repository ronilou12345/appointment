...
async function getDoctorAppointments(userId: string): Promise<DoctorAppointmentRow[]> {
  ...
  const normalizeTimeValue = (value: Date | string | null | undefined) => {
    if (!value) return ""
  ...
  try {
    ...
    return appointments.map((appointment) => {
      ...
      return {
        ...
        patientAge: appointment.age != null ? `${String(appointment.age)} years old` : "—",
    ...
    console.error("Doctor appointments query failed:", error)
    return []
  }
}
